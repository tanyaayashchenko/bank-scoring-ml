...
**Данные:** Реальные обезличенные исторические данные из системы OCRM ПАО "Альфа-Банк", предоставленные для реализации учебного проекта. Исходные данные очиищены от конфиденциальной информации, названия полей переименованы.
